            ...
            <div className="container mt-5 py-5">
                <div className="row">
                    <div className="col-12 mb-5 d-flex justify-content-center">
                        <Link to={'/nueva'} className="btn btn-success text-uppercase py-2 px-5 font-weight-bold">Crear Registro</Link>
                    </div> 
                        ...
                        <div className="list-group"> 
                            {citas.map(cita => (
                                <Link to={`/cita/${cita._id}`} key={cita._id} className="p-5 list-group-item list-group-item-action flex-column align-items-start">
                                    ...
                                    <p className="mb-0"> Mensaje:  
                                        {cita.sintomas}
                                    </p>
                                    <div className="contacto pt-3">
                                        <p>Appellido: {cita.propietario}</p>
